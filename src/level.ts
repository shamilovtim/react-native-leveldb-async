...
// TODO: long term smoke test and then remove this comment
// import * as fs from "expo-file-system";

export class ReactNativeLevelDBAsync<K, V> extends AbstractLevel<
  Uint8Array | string,
  K,
  V
> {
  _db?: LevelDB;
  location: string;
  _openIterators: Set<ReactNativeLevelDBAsyncIterator<K, V>> = new Set();
  ...
  protected async _open(
    ...
    try {
      /**
       * TODO: Disabled due to unnecessary and unused dependency on FS in fact
       * TODO: down in the catch block this did nothing since the error
       * TODO: gave no new information.
       */
  ...
  protected _iterator(
    ...
    const it = new ReactNativeLevelDBAsyncIterator<K, V>(this, options);
...
export class ReactNativeLevelDBAsyncIterator<K, V> extends AbstractIterator<
  ReactNativeLevelDBAsync<K, V>,
  Uint8Array,
  Uint8Array
> {
  it: LevelDBIterator;
